...
from clients.courses.courses_schema import UpdateCourseRequestSchema, UpdateCourseResponseSchema, GetCoursesQuerySchema, \
    GetCoursesQueryResponseSchema, CreateCourseRequestSchema, CreateCourseResponseSchema
...
class TestCourses:
    ...
    def test_get_courses(
        ...
        response_data = GetCoursesQueryResponseSchema.model_validate_json(response.text)
    ...
    def test_update_course(self, courses_client: CoursesClient, function_course: CoursesFixtures):
    ...
    def test_create_course(
        ...
        # Формируем запрос на создание курса
