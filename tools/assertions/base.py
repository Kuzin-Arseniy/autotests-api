...
def assert_status_code(actual: int, expected: int):
    ...
    """
    logger.info(f"Check that response status code is equal to {expected}") # Логируем проверку
...
def assert_equal(actual: Any, expected: Any, name: str):
    ...
    :raises: AssertionError: Если фактическое и ожидаемое значения не совпадают
    """
