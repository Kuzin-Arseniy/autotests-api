from clients.courses.courses_schema import UpdateCourseRequestSchema, UpdateCourseResponseSchema, \
    CreateCourseResponseSchema, CourseSchema, GetCoursesQueryResponseSchema, CreateCourseRequestSchema
...
def assert_get_courses_response(
        get_courses_response: GetCoursesQueryResponseSchema,
    ...
    assert_length(get_courses_response.courses, create_course_responses, "course")
