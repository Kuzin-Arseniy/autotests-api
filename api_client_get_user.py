...
# Инициализируем запрос на создание пользователя, используя pydantic-модель
...
# Инициализируем пользовательские данные для аутентификации, используя pydantic-модель
